...
public class TestCache implements Cache {
    ...
    /**
     * Constructs an instance of the TestCache at the specified directory.
     *
     * @param rootDirectory       The root directory of the cache.
     * @param maxCacheSizeInBytes The maximum size of the cache in bytes.
     */
    public TestCache(File rootDirectory, int maxCacheSizeInBytes) {
        mRootDirectory = rootDirectory;
        mMaxCacheSizeInBytes = maxCacheSizeInBytes;
    }

    /**
     * Constructs an instance of the TestCache at the specified directory using
     * the default maximum cache size of 5MB.
     *
     * @param rootDirectory The root directory of the cache.
     */
    public TestCache(File rootDirectory) {
    ...
    private void callbackEntryLisn(TestEntry entry) {
    ...
    public synchronized Entry get(String key) {
        ...
        try {
            ...
            TestEntry entry = cacheHeader.toCacheEntry(data);
    ...
    /**
     * Initializes the TestCache by scanning for all files currently in the
    ...
    static class CacheHeader {
         ...
         */
        public TestEntry toCacheEntry(byte[] data) {
