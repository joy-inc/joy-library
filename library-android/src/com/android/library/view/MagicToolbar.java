 ...
 */
public class MagicToolbar extends Toolbar implements DimenCons {
    ...
    public MagicToolbar(Context context, AttributeSet attrs) {

        this(context, attrs, android.support.v7.appcompat.R.attr.toolbarStyle);
    }

    public MagicToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
